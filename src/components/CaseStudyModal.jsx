...
import { X, ExternalLink, Zap, Shield, Cpu, Database, CheckCircle2, ArrowRight } from "lucide-react";
...
export default function CaseStudyModal({ caseStudyId, onClose }) {
  ...
  return (
    <div className="casestudy-backdrop" onClick={onClose}>
          ...
          <div className="casestudy-section">
            ...
            <ul className="features-list">
              {data.features.map((feat, idx) => (
                <li key={idx}>
                  <CheckCircle2 size={16} className="feat-icon" /> {feat}
                </li>
              ))}
            </ul>
          </div>
